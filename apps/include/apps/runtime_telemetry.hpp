...
struct RuntimeTelemetry {
  ...
  struct CanData {
    fsai::io::can::CanIface::Mode mode{fsai::io::can::CanIface::Mode::kSimulation};
    std::string endpoint;
    ...
    std::optional<fsai::io::can::ImuSample> imu{};
    std::optional<fsai::io::can::GpsSample> gps{};
  } can;
  ...
  struct ControlData {
    ...
    std::optional<fsai::io::can::Ai2VcuCommandSet> last_command{};
  } control;
