...
int main(int argc, char* argv[])
{
    ...
    while (running) {
        ...
        drawCones(renderer, track.leftCones, SDL_Color{30, 144, 255, 255}, bounds, renderWidth, renderHeight, kViewMargin, 6.0f);
        drawCones(renderer, track.rightCones, SDL_Color{255, 215, 0, 255}, bounds, renderWidth, renderHeight, kViewMargin, 6.0f);
        drawCones(renderer, track.startCones, SDL_Color{255, 140, 0, 255}, bounds, renderWidth, renderHeight, kViewMargin, 8.0f);
