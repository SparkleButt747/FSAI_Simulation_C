...
int main(void) {
    ...
    while (1) {
        ...
        float carScreenY = (float)controller.carState.y + g.height / 2.0f; // Adjust if needed.
        float carRadius = 10.0f; // Example radius.
        float carYaw = (float)controller.carState.yaw; // Use car state's yaw.
